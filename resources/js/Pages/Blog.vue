...
<template>
    ...
    <div class="text-center pt-16 md:pt-32">
        ...
        <h1 class="font-bold break-normal text-3xl md:text-5xl">Welcome To One Life</h1>
    </div>

    <!--image-->
    <div class="container w-full max-w-6xl mx-auto bg-white bg-cover mt-8 rounded" style="background-image:url('https://source.unsplash.com/collection/b3pp1fkKsCw'); height: 75vh;"></div>

    <!--Container-->
    <div class="container max-w-7xl mx-auto -mt-32">
